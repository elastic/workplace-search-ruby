...
Gem::Specification.new do |s|
  ...
  s.summary     = 'Official gem for accessing the Elastic Workplace Search API'
  s.description = 'API client for accessing the Elastic Workplace Search API with no dependencies.'
